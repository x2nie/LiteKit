...
type
  ...
  private
    FReport: T_Report;
    L_Pdf: TlqLabel;
    Bt_PdfEmptyPage: TlqButton;
    Bt_PdfSimpleText: TlqButton;
    Bt_PdfMultiPages: TlqButton;
    Bt_PdfMultiSections: TlqButton;
    Bt_PdfOutlines: TlqButton;
    Bt_PdfFrames: TlqButton;
    Bt_PdfColor: TlqButton;
    Bt_PdfLines: TlqButton;
    Bt_PdfGrid: TlqButton;
    Bt_PdfGraph: TlqButton;
    Bt_PdfSurf: TlqButton;
    Bt_PdfImages: TlqButton;
    Bt_PdfTtfFont: TlqButton;
    L_Visu: TlqLabel;
    Bt_VisuEmptyPage: TlqButton;
    Bt_VisuSimpleText: TlqButton;
    Bt_VisuMultiPages: TlqButton;
    Bt_VisuMultiSections: TlqButton;
    Bt_VisuOutlines: TlqButton;
    Bt_VisuFrames: TlqButton;
    Bt_VisuColor: TlqButton;
    Bt_VisuLines: TlqButton;
    Bt_VisuGrid: TlqButton;
    Bt_VisuGraph: TlqButton;
    Bt_VisuSurf: TlqButton;
    Bt_VisuImages: TlqButton;
    Bt_VisuTtfFont: TlqButton;
    L_Print: TlqLabel;
    Bt_PrintEmptyPage: TlqButton;
    Bt_PrintSimpleText: TlqButton;
    Bt_PrintMultiPages: TlqButton;
    Bt_PrintMultiSections: TlqButton;
    Bt_PrintOutlines: TlqButton;
    Bt_PrintFrames: TlqButton;
    Bt_PrintColor: TlqButton;
    Bt_PrintLines: TlqButton;
    Bt_PrintGrid: TlqButton;
    Bt_PrintGraph: TlqButton;
    Bt_PrintSurf: TlqButton;
    Bt_PrintImages: TlqButton;
    Bt_PrintTtfFont: TlqButton;
    L_Settings: TlqLabel;
    Ckb_Preferences: TlqCheckBox;
    P_Zoom: TlqPanel;
    SE_Zoom: TlqSpinEdit;
    L_Zoom: TlqLabel;
    P_Layout: TlqPanel;
    RB_Single: TlqRadiobutton;
    RB_Two: TlqRadiobutton;
    RB_Continuous: TlqRadiobutton;
    Bt_FontDir: TlqButton;
    Bt_Exit: TlqButton;
