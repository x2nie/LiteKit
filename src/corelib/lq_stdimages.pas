{
    ...
    Description:
      Standard LiteKit images that will be used in things like Message,
...
procedure lqCreateStandardImages;
...
begin
  ...
  // disabled state
  lqImages.AddMaskedBMP(  // 7x4 image
            'sys.sb.up',
            @stdimg_arrow_up,
  ...
  lqImages.AddMaskedBMP(  // 4x7 image
            'sys.sb.left',
            @stdimg_arrow_left,
  ...
  lqImages.AddBMP(  // 65x13 pixels. 5 images of 13x13 each.
            'sys.checkboxes',
            @stdimg_checkboxes,
